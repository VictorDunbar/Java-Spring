    ...
    <%@ taglib prefix = "fmt" uri = "http://java.sun.com/jsp/jstl/fmt" %>
        <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
            <%@page import="java.util.*"%>
                <%@page import="com.codingdojo.subs.models.User"%>
                    <%@page import="com.codingdojo.subs.models.Sub"%>
                        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                            ...
                            <body>
                                            ...
                                            <% User user = all.get(i); %>
                                                <% if(user.getSub() != null) { %>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <fmt:formatDate pattern="EEEEEE, 'the' dd 'of' MMMM, yyyy" value="<%= user.getDueDate() %>" />
                                                        </td>
                                                        <td>
                                                            <%= user.getSub().getPrice() %>
                                                        </td>
                                                        <td>
                                                            <%= user.getSub().getName() %>
                                ...
                                <table>
                                    ...
                                    <% List<Sub> allsubs = (List<Sub>) request.getAttribute("allsubs"); %>
                                        <% for(int i = 0; i < allsubs.size(); i++) { %>
                                            <% Sub sub = allsubs.get(i); %>
                                                <tr>
                                                    <td>
                                                        <%= sub.getName() %>
                                                    </td>
